...
{    
    ...
    CGContextAddArc(context, 8, 8, 4, 0, radians(360), 0);
    CGContextFillPath(context);
 
    CGContextAddArc(context, 18, 18, 4, 0, radians(360), 0);
    CGContextFillPath(context);
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor * bgColor = [UIColor colorWithHue:0.89 saturation:1 brightness:0.6 alpha:1.0];
